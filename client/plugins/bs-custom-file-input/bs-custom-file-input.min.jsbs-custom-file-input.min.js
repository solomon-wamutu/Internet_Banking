...
!(function (e, t) {
  ...
  function p() {
    for (
      var e = [].slice
          .call(this.querySelectorAll(d.INPUT))
          .filter(function (e) {
    ...
    init: function (e, t) {
      ...
      for (var a = 0, s = o.length; a < s; a++)
        o[a].addEventListener(L, p),
          Object.defineProperty(o[a], m, { value: !0, writable: !0 });
    },
    destroy: function () {
      for (
        var e = [].slice
            .call(document.querySelectorAll(d.FORM))
            .filter(function (e) {
              return !!e.bsCustomFileInput;
            }),
          t = [].slice
            .call(document.querySelectorAll(d.INPUT))
            .filter(function (e) {
              return !!e.bsCustomFileInput;
            }),
          n = 0,
      ...
      for (var i = 0, o = e.length; i < o; i++)
        e[i].removeEventListener(L, p), (e[i][m] = void 0);
    },
  };
});
