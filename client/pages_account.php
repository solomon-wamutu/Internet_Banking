...
$upd = "UPDATE ib_clients SET name = ?,national_id=?,phone=?,email=?,address=?,profile_pic=? WHERE client_number = ? ";
...
$upd = "UPDATE ib_clients SET password = ? WHERE client_id = ?";
$stmt = $mysqli->prepare($upd);
$bp = $stmt->bind_param('si',$password,$client_id);
$stmt ->execute();

if($stmt){
    $success = "Client Password Updated Successfully";
}else{
    $err = "Please Try Again or Try later";
}
}
        ...
        <section class="content-header">
                ...
                <section class="content">
                    ...
                    <div class="card-body">
                        ...
                        <p class="text-muted">
                        B.S. in Statistics and Computer Science from the Technical University of Mombasa
                        </p>
                        ...
                        <p class="text-muted">Tudor, Mombasa</p>
